# Social-Media-OSINT-Tools-AHM7D-Sy_Collection

A group of the most dangerous tools in the world in search and investigation of communication sites was collected after the fatigue and trouble of the Palestinian engineer AHM7D
...
#هل استخدام Osint غير قانوني؟

لا ، يعد استخدام osint قانونيًا ، ولكن إذا استخدمت المعلومات التي تم الحصول عليها عبر osint لأغراض غير قانونية أو بنوايا خاطئة ، فسيكون ذلك غير قانوني انا ليست مسؤال عن شيئ المستودع لاغراض تعليمية فقط.

سنقوم بإدراج العديد من الأدوات الأخرى في المستقبل في هذا الريبو ، وسأحاول الحفاظ عليها لفترة طويلة وسنستمر في إضافة المزيد والمزيد.


#اللتواصل والاسستفسار عن اي شيئ حساباتي يمكنكم متابعتها.

GitHub -https://github.com/Jokergazaa/

Telegram -https://t.me/jokerplstaeen

facebook -https://www.facebook.com/AHM7D.JOKER/
